...
public class Home implements Serializable, Cloneable {
  ...
  private Home(List<HomePieceOfFurniture> furniture, float wallHeight) {
    ...
    this.wallPoints = new ArrayList<WallPoint>();
  ...
  public void addWallPoint(WallPoint point) {
    if(!wallPoints.contains(point)) {
      wallPoints.add(point);
    }
  }
  
  public void deleteWallPoint(WallPoint point) {
    wallPoints.remove(point);
  }
  /**
   * Returns an unmodifiable collection of the walls of this home.
   */
  public Collection<WallPoint> getWallPoints() {
    return Collections.unmodifiableCollection(this.wallPoints);
  }
  ...
  public void addWall(Wall wall) {
    ...
    addWallPoint(wall.getStartPoint());
    addWallPoint(wall.getEndPoint());
  }
  ...
  public void deleteWall(Wall wall) {
    ...
    wall.detachJoinedWall(wall.getEndPoint());
    wall.detachJoinedWall(wall.getStartPoint());
