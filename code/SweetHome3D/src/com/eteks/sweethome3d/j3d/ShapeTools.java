...
public class ShapeTools {
  ...
  /**
   * Returns the shape of a polyline.float []
   */
  public static Shape getPolylineShape(Vector2D[] points, boolean curved, boolean closedPath) {
    return getPolylineShape(Vector2D.toFloatArray(points), curved, closedPath);
  }
  ...
  public static Shape getShape(Vector2D[] points, boolean closedPath, AffineTransform transform) {
    return getShape(Vector2D.toFloatArray(points), closedPath, transform);
  }
  /**
   * Returns the shape matching the coordinates in <code>points</code> array.
   */
