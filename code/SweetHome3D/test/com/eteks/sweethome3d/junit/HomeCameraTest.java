...
public class HomeCameraTest extends ComponentTestFixture {
  public void testHomeCamera() throws ComponentSearchException, InterruptedException, 
    ...
    Vector2D[] cameraPoints = observerCamera.getPoints();
    int xYawIndicator = (int)(((40 + (cameraPoints[0].x + cameraPoints[3].x) / 2)) * planComponent.getScale());
    int yYawIndicator = (int)(((40 + (cameraPoints[0].y + cameraPoints[3].y) / 2)) * planComponent.getScale());
    ...
    int xPitchIndicator = (int)(((40 + (cameraPoints[1].x + cameraPoints[2].x) / 2)) * planComponent.getScale());
    int yPitchIndicator = (int)(((40 + (cameraPoints[1].y + cameraPoints[2].y) / 2)) * planComponent.getScale());
    tester.actionMousePress(planComponent, new ComponentLocation(
