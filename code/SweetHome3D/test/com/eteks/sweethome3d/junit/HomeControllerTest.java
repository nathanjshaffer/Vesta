...
public class HomeControllerTest extends TestCase {
  ...
  private float getMinX(HomePieceOfFurniture piece) {
    return Vector2D.getMinX(piece.getPoints());
  }
  ...
  private float getMaxX(HomePieceOfFurniture piece) {
    return Vector2D.getMaxX(piece.getPoints());
  }
  ...
  private float getMinY(HomePieceOfFurniture piece) {
    return Vector2D.getMinY(piece.getPoints());
  }
  ...
  private float getMaxY(HomePieceOfFurniture piece) {
    return Vector2D.getMaxY(piece.getPoints());
  }
  ...
  private Rectangle2D getSurroundingRectangle(HomePieceOfFurniture piece) {
    ...
    Rectangle2D rectangle = new Rectangle2D.Float(points [0].x, points [0].x, 0, 0);
    for (int i = 1; i < points.length; i++) {
      rectangle.add(points [i]);
    }
    return rectangle;
  }
