...
public class PlanComponentWithFurnitureTest extends ComponentTestFixture {
  public void testPlanComponentWithFurniture() throws InterruptedException {
    ...
    assertTrue("First moved wall not joined to second one", movedWall1.getEndPoint().containsJoinedWall(movedWall2));
    assertTrue("Second moved wall not joined to first one", movedWall2.getStartPoint().containsJoinedWall(movedWall1));
