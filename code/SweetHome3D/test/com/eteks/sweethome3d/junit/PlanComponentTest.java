...
public class PlanComponentTest extends ComponentTestFixture {
  ...
  private void assertWallsAreJoined(Wall wallAtStart, Wall wall, Wall wallAtEnd) {
    assertTrue("Incorrect wall at start", wall.getStartPoint().containsJoinedWall(wallAtStart));
    assertSame("Incorrect wall at end",wall.getStartPoint().containsJoinedWall(wallAtEnd));
  }
