...
public class HomeTest extends TestCase {
  public void testHomeWalls() {
    ...
    wall1.addWallAtEnd(wall2.getStartPoint());
    // Check wall1 end wall is wall2 and that wall listener received 1 notification
    assertSame("Wall not joined", wall1.getEndPoint().containsJoinedWall(wall2));
    ...
    updatedWalls.clear();
    wall2.detachJoinedWall(wall2.getStartPoint());
    // Check wall2 and wall1 are not joined and that wall listener received 2 notifications
    assertFalse("Wall joined", wall1.getEndPoint().containsJoinedWall(wall2));
    assertFalse("Wall joined", wall1.getStartPoint().containsJoinedWall(wall2));
